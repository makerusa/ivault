...
type ProvisionFile struct {
	...
	Timezone      string        `json:"timezone"` // account IANA tz; seeds the schedule zone from first boot
...
func Process(mountPoint string, cfgPath string, database *db.DB) (bool, error) {
